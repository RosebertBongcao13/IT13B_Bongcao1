...
public class JavaLoginGUIwithFileHandling {



 public JavaLoginGUIwithFileHandling() {
    ...
    private boolean authenticateUser(String username, String encryptedPassword) {
        try (BufferedReader myReader = new BufferedReader(new FileReader("C:\\Users\\PC\\Documents\\users.txt"))) {
            String line;
